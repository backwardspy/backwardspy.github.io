...
it turns out there have been quite a few people making really _tiny_ little
fonts.
...
each row. this 3x3 is _almost_ small enough to store entire characters as
a single byte each.
...
if you double the columns to 2x5, you enter the realm of what we can now call _extremely legible_.
...
to represent a character, and into the realm of _redefining_ what a character
even is.
